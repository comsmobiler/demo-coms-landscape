...
namespace COMSSmobilerDemo.common
{
    class WorkDInfo
    {
        ...
        public DataTable GetKPI()
        {
            ...
            table.Columns.Add("USER_OBJMENDAYRATE", typeof(System.String));
            table.Columns.Add("WDOC_MENDAY1", typeof(System.Decimal));
            table.Columns.Add("USER_OBJMENDAY1", typeof(System.Decimal));
            table.Columns.Add("USER_OBJMENDAY1RATE", typeof(System.String));
            table.Rows.Add("201601", "!\\uf087000255128", 2,178,"1%",  0, 24,"0%");
            table.Rows.Add("201602", "!\\uf087000255128", 15, 178, "8%", 0, 24, "0%");
            table.Rows.Add("201603", "!\\uf087000255128", 0, 178, "0%", 0, 24, "0%");
            table.Rows.Add("201604", "!\\uf087000255128", 0, 178, "0%", 0, 24, "0%");
            table.Rows.Add("201605", "!\\uf087000255128", 0, 178, "0%", 0, 24, "0%");
            table.Rows.Add("201606", "!\\uf087000255128", 0, 178, "0%", 0, 24, "0%");
            table.Rows.Add("201607", "!\\uf087000255128", 0, 178, "0%", 0, 24, "0%");
            table.Rows.Add("201608", "!\\uf087000255128", 0, 178, "0%", 0, 24, "0%");
            table.Rows.Add("201609", "!\\uf087000255128", 0, 178, "0%", 0, 24, "0%");
            table.Rows.Add("201610", "!\\uf087000255128", 0, 178, "0%", 0, 24, "0%");
            table.Rows.Add("201611", "!\\uf087000255128", 0, 178, "0%", 0, 24, "0%");
            table.Rows.Add("201612", "!\\uf087000255128", 0, 178, "0%", 0, 24, "0%");
            return table;
        }
    }
}
